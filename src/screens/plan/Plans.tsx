...
//     //         <div className={`approval-type-box plan`}>
...
//             <div className="approval-type-box plan flex-shrink-0">
//               <i className="bi bi-calendar2-week-fill" />
//             </div>
...
//             {plan.type} {plan.title}
//           </span>
//           <div className="small text-green-muted mt-1">{plan.id}</div>
//         </td>
...
//               <div className="col-12 col-lg-6 col-xxl-4" key={plan.id}>
//                 <PlanCard plan={plan} />
//               </div>
//             ))}
//           </div>
